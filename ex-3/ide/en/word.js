...
//      _nonMatchDesc:"The Test case Instructions is not the same as actions!",
  ...
  _action:{
    ...
    _noLightAction:"Single-action execution",
...
//    shadow:"Show Shadow",
  ...
  _aiDefinition:{
    ...
    _help:{
      _maybeNoExist:"Ignore and continue execution if element match fails",
      _markErrorOnHidden:"Mark error on hidden element",
      _autoDelay:"Wait for last API call to complete",
      _noLightAction:"Enforce single-action execution",
      _failedReaction:"Disable retry functionality",
      _disableAISet:"Disable AI setting",
      _supportReadonlySet:"Support read-only field setting",
      _customizeDropdownInput:"Customize dropdown input",
      _alwaysExe:"Always executed (even if the current field data is bz-skip)",
      _allowExeOnHiddenElement:"Execute action even when element is hidden"
    },
    _key:"_"+"key",
    ...
    _alwaysExe:"Always executed (even if the current field data is bz-skip)",
    _maybeNoExist:"Continue execution if element does not exist or disabled",
